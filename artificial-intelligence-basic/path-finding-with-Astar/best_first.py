...
# Find path with Breath First Algorithm using heap
def bfs_with_heap(start, end):
...
# Find path with Breath First Algorithm using stack
def bfs_with_stack(start, end):
